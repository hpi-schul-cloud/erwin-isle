...
describe('InboundIdentityService ORM', () => {
    ...
    beforeEach(async () => {
        ...
        service = testingModule.get<EducationalIdentityService>(EducationalIdentityService);
...
describe('EducationalIdentityService db mock', () => {
    ...
    it('should allow to create a user', async () => {
        const ret = await service.create({
            preferredName: testEduId.preferredName,
        });
    ...
    it('should allow to remove a user', async () => {
        ...
        expect(ret).toStrictEqual<Result<EducationalIdentity>>({ success: true, value: testEduId });
    });
    ...
    it('should allow to find all users ', async () => {
        ...
        expect(ret).toStrictEqual<Result<Array<EducationalIdentity>>>({ success: true, value: [testEduId] });
    });
});
